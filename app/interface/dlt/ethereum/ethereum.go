...
func (ec *EthereumClient) GetTransactionInfo(txHash string) (result *txreceipt.TxRecepit, err error) {
	...
	receipt, err := ecClient.TransactionReceipt(context.Background(), hash)
	if err != nil {
		return nil, err
	}
